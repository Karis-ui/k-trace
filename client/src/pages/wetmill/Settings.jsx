// src/pages/wetmill/WetMillSettings.jsx
import React, { useState, useEffect } from "react";
import axios from "axios";
import { motion } from "framer-motion";
import { Save, Bell, UserCog, Shield, Sun, Moon, RefreshCw } from "lucide-react";

export default function WetMillSettings() {
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="space-y-6">
                    ...
                    <motion.div
                        ...
                        className="bg-white/90 p-6 rounded-xl shadow-lg border border-blue-50"
                    >
                    ...
                    >
                        <h2 className="text-lg font-bold text-blue-800 mb-4 flex items-center gap-2">
                            <Shield className="text-blue-500" /> Appearance & Language
                        </h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
